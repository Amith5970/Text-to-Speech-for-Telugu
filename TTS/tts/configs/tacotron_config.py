...
class TacotronConfig(BaseTTSConfig):
    ...
    test_sentences: List[str] = field(
        default_factory=lambda: [
          #  "ఆరు నెలల నుంచి పిల్లలమర్రి ఎంట్రన్స్ నుంచి తిరిగి వచ్చే వరకు ఎంత చెల్లిస్తున్నారు, ఏఏ విభాగానికి ఎంత ఆదాయం వస్తుందనే విషయాలపై నివేదిక తీసుకున్నారు.",
           # "భగీరధుని ప్రార్థనపై జహ్నముని గంగని విడిచిపెడ్తే, అప్పుడు గంగ ఆయన చెవిలో నుండి బయలుపడి జహ్ను ముని తనయ జాహ్నవి అయింది.",
            #"తీవ్రమైన చలి విండోస్ యొక్క సింగిల్ ఛాంబర్ వైవిధ్యాలు కూడా మంచు తో కప్పబడి ఉండవచ్చు.",
            #"జార్రే సాక్స్ సోలోపై రాన్ మక్నైర్ కోసం కూర్చున్న కిర్క్ వూలమ్ తో  తన పాట కోసం ప్రదర్శన ఇచ్చాడు హైడ్రాక్సైడ్ డైహైడ్రాక్సైడ్ హైడ్రేట్ హైడ్రాలిమ్.",
            #"పౌరసత్వ సవరణ చట్టం, భారతీయ పౌర జాతీయ, జాతీయ జనాభా జాబితాల వ్యతిరేక దేశవ్యాప్త నిరసనలు, అంతర్జాతీయ సమాజ అసంతృప్తి పెల్లుబికాయి.",
